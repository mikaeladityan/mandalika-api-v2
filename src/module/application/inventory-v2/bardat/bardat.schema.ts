...
export const RequestBardatSchema = z.object({
...
export const QueryBardatSchema = z.object({
...
export type RequestBardatDTO = z.infer<typeof RequestBardatSchema>;
export type QueryBardatDTO = z.infer<typeof QueryBardatSchema>;
