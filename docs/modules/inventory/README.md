...
| RM           | `/api/app/inventory/rm`                 | `src/module/application/inventory/rm`               | ✅ Ready | _(TBD)_                                  |
